...
const fmt = {
  // €1,234,567 — full, 0 decimal places
  eur: (v) => {
  ...
  // €7,32 — 2 decimal places (for unit costs / prices)
  eur2: (v) => {
    if (v == null || isNaN(v)) return "—";
    const sign = v < 0 ? "−" : "";
    const a = Math.abs(v);
    return sign + "€" + a.toLocaleString("pt-PT", { minimumFractionDigits: 2, maximumFractionDigits: 2 });
  },
