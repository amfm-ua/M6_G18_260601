...
const GRESTEL = (() => {
  ...
  function hubViability(irc_taxa = IRC_TAXA_EFETIVA) {
    ...
    return {
      ...
      parametros: {
        ...
        libertacao_inventario: 1727000,
        ano_inventario: 2026,
        dmi_reducao_dias: 20,
        dmi_clearing_dias: 24.5,
  ...
  function hubTornado() {
    ...
    return [
      ...
      { variavel: "Redução de DMI (dias)",             driver: "dmi_reducao_dias", desc_low: "10 d (pess.)",  desc_high: "28 d (otim.)",       low: -0.40, high:  0.32, impacto_total: 0.72 },
