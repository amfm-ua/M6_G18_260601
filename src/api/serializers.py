...
def _flatten_assumptions(a) -> dict[str, Any]:
    ...
    out["hc_2024"] = pessoal.get("headcount_2024", 734)
    out["hc_2025"] = pessoal.get("headcount_2025", 744)
    ...
    out["eco_subc_2024"] = float(trans.get("subcontratacao_2024", 8260000))
    out["eco_ced_2024"] = float(trans.get("cedencia_pessoal_2024", 2222745))

    ops = ecogres.get("operacoes_correntes", {}) or {}
    out["eco_custos_op_2024"] = float((ops.get("custos_operacionais_2024") or {}).get("total", 7880000))
    ...
    out["derrama_estadual"] = float(impostos.get("Derrama_Estadual", 0.03)) * 100
    ...
    out["tsu_efetiva"] = float(impostos.get("TSU_Efetiva", 0.1935)) * 100
