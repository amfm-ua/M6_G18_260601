...
ANO_FIM: int = 2034           # último ano de projeção

ANOS_PROJECAO: list[int] = list(range(ANO_ARRANQUE, ANO_FIM + 1))  # [2025..2034]
ANOS_MODELO: list[int] = [ANO_BASE] + ANOS_PROJECAO                # [2024..2034]
