...
def run_model(
    ...
    dfs = statements.build_statements(
        ...
        horizonte_maturidade=horizonte_maturidade,
    )
    ...
    try:
        ...
        dfs["pessoal_anual"] = pd.DataFrame(columns=["ano", "gastos_pessoal", "headcount", "fte_poupados_hub", "headcount_hub", "custo_medio", "peso_vn_pct"])
