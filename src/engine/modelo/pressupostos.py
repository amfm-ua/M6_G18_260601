...
from ..inputs.constants import YEARS
...
def build_pressupostos_summary(
    ...
    sections.append({
        ...
        "label": "Pessoal",
        "items": [
            _item("Headcount 2024", int(pessoal.get("headcount_2024", 734)), "pessoas"),
            _item("Headcount 2025", int(pessoal.get("headcount_2025", 744)), "pessoas"),
