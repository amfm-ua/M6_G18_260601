...
def pessoal_contab_anual(
    ...
    tsu_legal = float(a.pessoal_params.get("TSU_empregador", 0.2375))
    tsu_efetiva = float(a.pessoal_params.get("TSU_efetiva", tsu_legal))
    tsu = tsu_efetiva  # R&C 2024: taxa efetiva 19,35% (2.211.532,19€ / 11.428.817,69€)
